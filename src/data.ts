...
export const characters: CharacterResult[] = [
  ...
  },
  {
    ...
    vector: [2, 2, 3, 2],
    description: "现实派的大满贯选手！你踏实、稳重，不论外界多么喧嚣，你都有自己不变的鼓点节奏和原则。你精打细算、规则感极强，绝不轻易让自己在生活中失控，这也让你的日常充满了确定感和安全感。虽然你往往是人群中那个脾气最好、被大家拿来开善意玩笑的“吐槽对象”，但其实所有人心里都清楚，你是最坚决的后盾。没有你这稳如泰山的底盘，宇宙飞船绝对无法升空！",
